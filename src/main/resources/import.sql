...
-- After finish, delete all rows below
...
INSERT INTO class_students (idrow, classid, studentid) VALUES (400, 100, 10005);
...
INSERT INTO assessments (assessmentid, assessmentname, classid, startdate, expireddate, status) VALUES (103, 'Tin hoc', '100', '2020/6/10', '2020/7/30', true);
...
INSERT INTO results (id, answerchoice, score, startdate, updatedate, assessmentid, questionid, studentid) VALUES (301, 'D', 7 , '2020/6/10', '2020/7/15', 101, 100, 10007);
INSERT INTO results (id, answerchoice, score, startdate, updatedate, assessmentid, questionid, studentid) VALUES (302, 'A', 10 , '2020/6/10', '2020/7/15', 101, 102, 10007);
INSERT INTO results (id, answerchoice, score, startdate, updatedate, assessmentid, questionid, studentid) VALUES (303, 'D', 7 , '2020/6/10', '2020/7/20', 101, 103, 10007);

INSERT INTO results (id, answerchoice, score, startdate, updatedate, assessmentid, questionid, studentid) VALUES (304, 'D', 7 , '2020/6/10', '2020/7/15', 100, 1000, 10007);
INSERT INTO results (id, answerchoice, score, startdate, updatedate, assessmentid, questionid, studentid) VALUES (305, 'B', 10 , '2020/6/10', '2020/7/15', 100, 2000, 10007);
INSERT INTO results (id, answerchoice, score, startdate, updatedate, assessmentid, questionid, studentid) VALUES (306, 'D', 7 , '2020/6/10', '2020/7/20', 100, 3000, 10007);

INSERT INTO results (id, answerchoice, score, startdate, updatedate, assessmentid, questionid, studentid) VALUES (307, 'D', 7 , '2020/6/10', '2020/7/15', 102, 3004, 10007);
INSERT INTO results (id, answerchoice, score, startdate, updatedate, assessmentid, questionid, studentid) VALUES (308, 'D', 10 , '2020/6/10', '2020/7/15', 102, 3005, 10007);
INSERT INTO results (id, answerchoice, score, startdate, updatedate, assessmentid, questionid, studentid) VALUES (309, 'C', 7 , '2020/6/10', '2020/7/20', 102, 3006, 10007);
