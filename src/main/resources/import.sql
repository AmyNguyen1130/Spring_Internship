...
INSERT INTO users (userid, username, password, firstname, email, enabled, roleid) VALUES (1000015, 'admin15', '$2a$11$tUilnpRbUmpBxKWap3oUP..fNsY19D6n/WrdcXc94YnF4yCgXVJty', 'Administrator16', 'admin@codeenginestudio.com', true, 1);
INSERT INTO users (userid, username, password, firstname, email, enabled, roleid) VALUES (1000016, 'admin16', '$2a$11$tUilnpRbUmpBxKWap3oUP..fNsY19D6n/WrdcXc94YnF4yCgXVJty', 'Administrator17', 'admin@codeenginestudio.com', true, 1);
INSERT INTO users (userid, username, password, firstname, email, enabled, roleid) VALUES (1000017, 'admin17', '$2a$11$tUilnpRbUmpBxKWap3oUP..fNsY19D6n/WrdcXc94YnF4yCgXVJty', 'Administrator18', 'admin@codeenginestudio.com', true, 1);
INSERT INTO users (userid, username, password, firstname, email, enabled, roleid) VALUES (1000018, 'admin18', '$2a$11$tUilnpRbUmpBxKWap3oUP..fNsY19D6n/WrdcXc94YnF4yCgXVJty', 'Administrator19', 'admin@codeenginestudio.com', true, 1);

INSERT INTO roles (roleid, rolename) VALUES (1, 'Admin');
INSERT INTO roles (roleid, rolename) VALUES (2, 'Teaher');
