...
<nav class="navbar border-bottom navbar-expand">
	<div class="navbar-top-right col-sm-4">
		...
		<div class="col-sm-8 navbar-top-right">
			<a id="class" class="navbar-brand white tab-link" href="<c:url value="/teacher/class"/>">
				<spring:message code="classes"/>
			</a>
			<a id="assessment" class="navbar-brand white tab-link" href="<c:url value="/teacher/assessment"/>">
				<spring:message code="assessments"/>
			</a>
		</div>
	</div>
