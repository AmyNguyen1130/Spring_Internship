...
<head>
	...
	<link href="<c:url value="/css/datatables/dataTables.bootstrap4.css"/>"
		rel="stylesheet" type="text/css">
	<link href="<c:url value="/css/bootoast/bootoast.min.css"/>"
		rel="stylesheet" type="text/css">
	<!-- Custom fonts for this template-->
	<link
		href="//netdna.bootstrapcdn.com/font-awesome/5.5.0/css/font-awesome.css"
		rel="stylesheet" />
