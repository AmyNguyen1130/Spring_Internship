	    ...
	    <div class="col-sm-5">
		    <div class="row = 12">
			    <div class="col-sm-8">
				 ...
				 <div class="col-sm-4">
					<a href='/admin/class/addClass'><button class="btn btn-default" type="button">Add new class</button></a>
				</div>
	    		</div>
	    </div>
				...
				<c:forEach items="${classPage.getContent()}" var="class">
			       <tr>
				       ...
				       <td><a href="/admin/class/editClass?classid=<c:out value='${class.classid}' />">Edit</a> &emsp;
							...
							<a href="/admin/getTeacherAddToClass?classid=<c:out value='${class.classid}'/>"><button class="btn btn-default">Assign</button></a></td>
