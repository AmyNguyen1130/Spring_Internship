	...
	<div class="container-fluid row">
		...
		<div class="col-sm-5">
				<div class="row">
					...
					<div class="col-sm-4">
						<button id="userDropdown" role="button" data-toggle="dropdown" class="btn nav-link dropdown-toggle btn-pink " style="margin-left: 14px">
					<spring:message code="add-new-user"/>
				</button>
