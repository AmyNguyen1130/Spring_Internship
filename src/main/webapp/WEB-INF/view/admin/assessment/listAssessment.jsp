	    ...
	    <div class="col-sm-5">
		    <div class="row = 12">
			    <div class="col-sm-8">
				 ...
				 <div class="col-sm-4">
					<a href='/admin/assessment/addAssessment'><button class="btn btn-default" type="button">Add new assessment</button></a>
				</div>
	    		</div>
	    </div>
				...
				<c:forEach items="${assessmentPage.getContent()}" var="assessment">
			       <tr>
				       ...
				       <td>${assessment.startdate}</td>
				        ...
				        <td><a href="/admin/class/editClass?classid=<c:out value='${class.classid}' />">Edit</a> &emsp;</td>
...
<util:pagination
			...
			url="${pageContext.request.contextPath}/admin/assessment"
